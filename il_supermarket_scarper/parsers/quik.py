"""Quik parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class QuikParser(AbstractParser):
    """Parser for Quik XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Quik parser."""
        super().__init__(provider_name="Quik")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Quik store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Quik price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Quik promotion parsing.
