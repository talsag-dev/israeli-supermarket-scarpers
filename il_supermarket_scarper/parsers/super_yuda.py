"""SuperYuda parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class SuperYudaParser(AbstractParser):
    """Parser for SuperYuda XML format - TODO: Implement."""

    def __init__(self):
        """Initialize SuperYuda parser."""
        super().__init__(provider_name="SuperYuda")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement SuperYuda store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement SuperYuda price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement SuperYuda promotion parsing.
