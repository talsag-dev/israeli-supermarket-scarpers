"""Polizer parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class PolizerParser(AbstractParser):
    """Parser for Polizer XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Polizer parser."""
        super().__init__(provider_name="Polizer")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Polizer store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Polizer price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Polizer promotion parsing.
