"""KingStore parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class KingStoreParser(AbstractParser):
    """Parser for KingStore XML format - TODO: Implement."""

    def __init__(self):
        """Initialize KingStore parser."""
        super().__init__(provider_name="KingStore")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement KingStore store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement KingStore price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement KingStore promotion parsing.
