"""StopMarket parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class StopMarketParser(AbstractParser):
    """Parser for StopMarket XML format - TODO: Implement."""

    def __init__(self):
        """Initialize StopMarket parser."""
        super().__init__(provider_name="StopMarket")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement StopMarket store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement StopMarket price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement StopMarket promotion parsing.
