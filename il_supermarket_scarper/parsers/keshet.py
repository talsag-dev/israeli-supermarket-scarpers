"""Keshet parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class KeshetParser(AbstractParser):
    """Parser for Keshet XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Keshet parser."""
        super().__init__(provider_name="Keshet")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Keshet store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Keshet price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Keshet promotion parsing.
