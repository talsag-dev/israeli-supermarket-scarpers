"""MeshnatYosef parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class MeshnatYosefParser(AbstractParser):
    """Parser for MeshnatYosef XML format - TODO: Implement."""

    def __init__(self):
        """Initialize MeshnatYosef parser."""
        super().__init__(provider_name="MeshnatYosef")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement MeshnatYosef store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement MeshnatYosef price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement MeshnatYosef promotion parsing.
