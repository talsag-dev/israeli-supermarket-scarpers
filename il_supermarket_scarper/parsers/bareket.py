"""Bareket parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class BareketParser(AbstractParser):
    """Parser for Bareket XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Bareket parser."""
        super().__init__(provider_name="Bareket")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Bareket store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Bareket price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Bareket promotion parsing.
