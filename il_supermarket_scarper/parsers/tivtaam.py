"""Tivtaam parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class TivtaamParser(AbstractParser):
    """Parser for Tivtaam XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Tivtaam parser."""
        super().__init__(provider_name="Tivtaam")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Tivtaam store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Tivtaam price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Tivtaam promotion parsing.
