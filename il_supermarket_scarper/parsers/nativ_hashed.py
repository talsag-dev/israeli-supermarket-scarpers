"""NativHashed parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class NativHashedParser(AbstractParser):
    """Parser for NativHashed XML format - TODO: Implement."""

    def __init__(self):
        """Initialize NativHashed parser."""
        super().__init__(provider_name="NativHashed")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement NativHashed store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement NativHashed price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement NativHashed promotion parsing.
