"""Cofix parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class CofixParser(AbstractParser):
    """Parser for Cofix XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Cofix parser."""
        super().__init__(provider_name="Cofix")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Cofix store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Cofix price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Cofix promotion parsing.
