"""Osherad parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class OsheradParser(AbstractParser):
    """Parser for Osherad XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Osherad parser."""
        super().__init__(provider_name="Osherad")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Osherad store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Osherad price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Osherad promotion parsing.
