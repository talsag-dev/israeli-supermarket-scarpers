"""SalachDabach parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class SalachDabachParser(AbstractParser):
    """Parser for SalachDabach XML format - TODO: Implement."""

    def __init__(self):
        """Initialize SalachDabach parser."""
        super().__init__(provider_name="SalachDabach")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement SalachDabach store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement SalachDabach price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement SalachDabach promotion parsing.
