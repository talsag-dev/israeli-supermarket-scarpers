"""Bitan parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class BitanParser(AbstractParser):
    """Parser for Bitan XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Bitan parser."""
        super().__init__(provider_name="Bitan")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Bitan store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Bitan price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Bitan promotion parsing.
