"""Wolt parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class WoltParser(AbstractParser):
    """Parser for Wolt XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Wolt parser."""
        super().__init__(provider_name="Wolt")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Wolt store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Wolt price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Wolt promotion parsing.
