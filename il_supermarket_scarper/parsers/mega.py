"""Mega parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class MegaParser(AbstractParser):
    """Parser for Mega XML format - TODO: Implement."""

    def __init__(self):
        """Initialize Mega parser."""
        super().__init__(provider_name="Mega")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Mega store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Mega price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement Mega promotion parsing.
