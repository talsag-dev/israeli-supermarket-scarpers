"""ShefaBarcartAshem parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class ShefaBarcartAshemParser(AbstractParser):
    """Parser for ShefaBarcartAshem XML format - TODO: Implement."""

    def __init__(self):
        """Initialize ShefaBarcartAshem parser."""
        super().__init__(provider_name="ShefaBarcartAshem")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement ShefaBarcartAshem store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement ShefaBarcartAshem price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement ShefaBarcartAshem promotion parsing.
