"""ShukAhir parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class ShukAhirParser(AbstractParser):
    """Parser for ShukAhir XML format - TODO: Implement."""

    def __init__(self):
        """Initialize ShukAhir parser."""
        super().__init__(provider_name="ShukAhir")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement ShukAhir store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement ShukAhir price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement ShukAhir promotion parsing.
