"""HetCohen parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class HetCohenParser(AbstractParser):
    """Parser for HetCohen XML format - TODO: Implement."""

    def __init__(self):
        """Initialize HetCohen parser."""
        super().__init__(provider_name="HetCohen")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement HetCohen store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement HetCohen price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement HetCohen promotion parsing.
