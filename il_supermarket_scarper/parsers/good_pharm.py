"""GoodPharm parser XML parser - TODO: Implement."""
from typing import Dict, List

from .base import AbstractParser


class GoodPharmParser(AbstractParser):
    """Parser for GoodPharm XML format - TODO: Implement."""

    def __init__(self):
        """Initialize GoodPharm parser."""
        super().__init__(provider_name="GoodPharm")

    def parse_stores(self, xml_path: str) -> List[Dict]:
        """TODO: Implement GoodPharm store parsing.
    ...
    def parse_prices(self, xml_path: str) -> List[Dict]:
        """TODO: Implement GoodPharm price parsing.
    ...
    def parse_promotions(self, xml_path: str) -> List[Dict]:
        """TODO: Implement GoodPharm promotion parsing.
